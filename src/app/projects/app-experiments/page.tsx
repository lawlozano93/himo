                ...
                <section className="py-16 px-6 bg-[#191314]">
                    <div className="max-w-4xl mx-auto">
                        ...
                        <div className="space-y-6">
                            {/* BUBU */}
                            <Link href={`/projects/app-experiments/bubu`} className="block">
                                <div className="bg-[#2a2a2a] rounded-2xl p-8 hover:bg-[#333] transition-colors cursor-pointer">
                                    <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-6">
                                        <div className="flex-1">
                                            <div className="flex items-center gap-3 mb-3">
                                                <h2 className="text-3xl font-bold text-white">BUBU</h2>
                                            </div>
                                            <p className="text-[#ecf95a] font-medium mb-4">Rotating Savings Tracker for Paluwagan Groups</p>

                                            <div className="space-y-2 mb-6">
                                                <p className="text-neutral-400 text-sm">
                                                    <span className="text-neutral-300 font-medium">Problem:</span> Filipino rotating savings (paluwagan) are tracked via paper or group chats. Easy to lose, hard to verify.
                                                </p>
                                                <p className="text-neutral-400 text-sm">
                                                    <span className="text-neutral-300 font-medium">Solution:</span> A simple web app: create groups, invite members, track contributions, auto-advance cycles.
                                                </p>
                                            </div>
                            ...
                            {/* Building Himo */}
                            <Link href="/projects/app-experiments/making-himo" className="block">
                                <div className="bg-[#2a2a2a] rounded-2xl p-8 hover:bg-[#333] transition-colors cursor-pointer h-full flex flex-col">
                                    <div className="flex items-center justify-between mb-2">
                                        <h3 className="text-2xl font-bold text-white">Building himo</h3>
                                        <div className="flex items-center gap-2 text-neutral-400 hover:text-white transition-colors shrink-0">
                                            <span className="text-sm font-medium">Read Case Study</span>
                                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor" className="w-4 h-4">
                                                <path strokeLinecap="round" strokeLinejoin="round" d="M4.5 19.5l15-15m0 0H8.25m11.25 0v11.25" />
                                    ...
                                    <p className="text-[#ecf95a] font-medium mb-4">Portfolio Construction & AI Meta-analysis</p>
